...
///<summary>Generic collection which allows adding and enumeration of a list of any type objects.</summary>
public class Objs<T> : IEnumerable<T>
{
	// List which holds all the objects.
	private List<T> _objs = new List<T>();
	///<summary>Adds the object to Objs collection.</summary>
	...
	///<summary>Generic method to return an enumerator for foreach implementation.</summary>
	public IEnumerator<T> GetEnumerator()
	{
		return _objs.GetEnumerator();
	}

	///<summary>Backwards-compatible method for returning an enumerator as an object.</summary>
