...
public class Player
{
	...
	// Prints a warning for low or zero health, depending on CurrentHPArgs.
	private void HPValueWarning(object sender, CurrentHPArgs e)
	{
		if (e.currentHp == 0)
		{
			Console.BackgroundColor = ConsoleColor.Red;
			System.Console.Write("Health has reached zero!");
		}
		else
		{
			Console.ForegroundColor = ConsoleColor.Red;
			System.Console.Write("Health is low!");
		}
		Console.ResetColor();
	...
	///<summary>Decides whether to run HPValueWarning to HPCheck before calling HPCheck,
	/// based on CurrentHPArgs.</summary>
	///<param name= "e">Event arguments containing current hp information.</param>
